...
import static br.com.intersol.util.Constants.VIEW_PESQUISAR_USUARIO;
import static br.com.intersol.util.Constants.VIEW_USUARIO_NOVO;
import static br.com.intersol.util.Constants.VIEW_USUARIO_REDIRECT;
...
public class UsuariosController {
	...
	@GetMapping
	public ModelAndView pesquisar(UsuarioFilter usuarioFilter, BindingResult result, @PageableDefault(size = 25) Pageable pageable) {
